...
#include <memory>
#include "../../Client-Demo3/ChatWidget.h"
...
QT_MOC_LITERAL(1, 11, 14), // "sendMesgSignal"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 13), // "targetAccount"
QT_MOC_LITERAL(4, 41, 7), // "payload"
QT_MOC_LITERAL(5, 49, 21) // "on_pushButton_clicked"

    },
    "ChatWidget\0sendMesgSignal\0\0targetAccount\0"
    "payload\0on_pushButton_clicked"
};
...
void ChatWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendMesgSignal((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        ...
        {
            using _t = void (ChatWidget::*)(QString , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ChatWidget::sendMesgSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ChatWidget::sendMesgSignal(QString _t1, QString _t2)
{
