...
#include <memory>
#include "../../Client-Demo3/AddFriendDialog.h"
...
QT_MOC_LITERAL(1, 16, 15), // "addFriendSignal"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 7), // "account"
QT_MOC_LITERAL(4, 41, 21) // "on_pushButton_clicked"

    },
    "AddFriendDialog\0addFriendSignal\0\0"
    "account\0on_pushButton_clicked"
};
...
void AddFriendDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->addFriendSignal((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            using _t = void (AddFriendDialog::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AddFriendDialog::addFriendSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void AddFriendDialog::addFriendSignal(QString _t1)
{
