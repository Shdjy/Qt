...
#include <memory>
#include "../../Client-Demo3/MyTcpSocket.h"
...
QT_MOC_LITERAL(1, 12, 7), // "newMesg"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 4), // "mesg"
QT_MOC_LITERAL(4, 26, 15), // "readyReadHandle"
QT_MOC_LITERAL(5, 42, 18), // "disconnectedHandle"
QT_MOC_LITERAL(6, 61, 10), // "sendHandle"
QT_MOC_LITERAL(7, 72, 5) // "char*"

    },
    "MyTcpSocket\0newMesg\0\0mesg\0readyReadHandle\0"
    "disconnectedHandle\0sendHandle\0char*"
};
...
void MyTcpSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->newMesg((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->readyReadHandle(); break;
        case 2: _t->disconnectedHandle(); break;
        case 3: _t->sendHandle((*reinterpret_cast< char*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTcpSocket::newMesg)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyTcpSocket::newMesg(QString _t1)
{
